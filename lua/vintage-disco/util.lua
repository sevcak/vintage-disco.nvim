local ts = require("vintage-disco.treesitter")
...
function M.invert_color(color)
  local hsluv = require("vintage-disco.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("vintage-disco", { clear = true })
...
function M.load(theme)
  ...
  vim.g.colors_name = "vintage-disco"
