...
local colors = require("vintage-disco.colors")
...
function M.setup()
  ...
  theme.highlights = {
    ...
    CursorLine = { bg = c.base04, sp = c.base1 }, -- Screen-line at the cursor, when 'cursorline' is set.  Low-priority if foreground (ctermfg OR guifg) is not set.
    ...
    CursorLineNr = { fg = c.cyan300, sp = c.base1, bold = true }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    ...
    NormalSB = { fg = c.base00, bg = c.bg_sidebar }, -- normal text in sidebar
    ...
    StatusLine = { fg = c.base1, bg = c.base00 }, -- status line of current window
    ...
    --- Functions
    ["@constructor"] = { fg = c.magenta100 }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
    ["@variable.parameter"] = { fg = c.magenta100 }, -- For parameters of a function.
    ...
    ["@variable.builtin"] = { fg = c.cyan100 }, -- Variable names that are defined by the languages, like `this` or `self`.
    ["@module.builtin"] = { fg = c.cyan100 }, -- Variable names that are defined by the languages, like `this` or `self`.
    ...
    ["@keyword.return.tsx"] = { fg = c.green100, style = "italic" },
    ["@keyword.tsx"] = { fg = c.green100, style = "italic" },
    ...
    ["@keyword.return.javascript"] = { fg = c.green100, style = "italic" },
