...
function M.setup()
  ...
  theme.highlights = {
    ...
    --- Functions
    ["@constructor"] = { fg = c.magenta300 }, -- For constructor calls and definitions: `= { }` in Lua, and Java constructors.
    ["@variable.parameter"] = { fg = c.magenta300 }, -- For parameters of a function.
